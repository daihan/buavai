...
<div id="head-wrapper">
    <div id="head-bar">
        ...
        <ul class="main-menu" style="overflow:visible">            
            ...
            <li><a class="{if $menu eq 3}current{/if}" href="{$baseurl}/trending">{*$lang253*}Xu hướng</a></li>            
            <li><a class="{if $menu eq 4}current{/if}" href="{$baseurl}/vote">{$lang173}</a></li>
            <li><a class="" href="http://memeful.com/" target="_blank">Chế MeMe</a></li>            
        </ul>
        <ul class="main-2-menu">
            <li>
                <form action="{$baseurl}/search">
                    <input id="sitebar_search_header" type="text" class="" name="query" tabindex="1" placeholder="{$lang189}"/>
                </form>
            </li>
            ...
            <li><a class="add-post {if $menu eq 3}current{/if}" href="{$baseurl}/submit" onclick="_gaq.push(['_trackEvent', 'New-Post', 'Clicked', 'Headbar', 1]);">Upload</a></li>
        </ul>
    </div>
    {if $homepage eq "1"}
