			...
			if($file == "1")
			{
				...
				if($post_type == "Photo")
				{
					...
					else
					{
						...
						if($theimageinfo[2] != 2 && $theimageinfo[2] != 3 && $theimageinfo[2] != 1)
						{
							$error = $lang['94'];
						}
						else
									...
									if($error == "")
									{
										...
										if(file_exists($config['pdir']."/".$thepp))
										{
											...
											if($config['wm'] == "1")
											{
                                                ...
                                                elseif($thepp2 == ".gif")
												{
													$img=imagecreatefromgif($config['pdir']."/".$thepp);
												}
												else
												{
													$wskip = "1";	
												...
												{		
                                                    ...
                                                    if($thepp2 == ".gif") {
                                                        imagegif($image, $config['pdir']."/".$thepp, 90);
                                                    }
													else imagejpeg($image, $config['pdir']."/".$thepp, 90);
												}
											}
