...
$cauhinh = fopen("$basedir/include/config.php", "w");
if(!$cauhinh)
{
...
$cauhinh_m = fopen("$basedir/m/config.php", "w");
if(!$cauhinh_m)
{
...
$htaccess_file = fopen("$basedir/.htaccess", "w");
if(!$htaccess_file)
{
...
$htaccess_file_m = fopen("$basedir/m/.htaccess", "w");
if(!$htaccess_file_m)
{
