<?php /* Smarty version 2.6.6, created on 2013-11-05 15:44:58
...
" class=" required-entry required-entry input-text" type="text"/>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            ...
                                                            <option value="1" <?php if ($this->_tpl_vars['wm'] == '1'): ?>selected<?php endif; ?>>Có</option>
                											<option value="0" <?php if ($this->_tpl_vars['wm'] == '0'): ?>selected<?php endif; ?>>Không</option>
                                                            </select>
                                                        </td>
...
" class=" required-entry required-entry input-text" type="text"/>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            ...
                                                            <option value="1" <?php if ($this->_tpl_vars['infinity_paging'] == '1'): ?>selected<?php endif; ?>>Không Giới Hạn</option>
                											<option value="0" <?php if ($this->_tpl_vars['infinity_paging'] == '0'): ?>selected<?php endif; ?>>Bình Thường</option>
                                                            </select>
                                                        </td>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            <input id="profile_max" name="profile_max" value="<?php echo $this->_tpl_vars['profile_max']; ?>
" class=" required-entry required-entry input-text" type="text"/>
                                                        </td>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            ...
                                                            <option value="1" <?php if ($this->_tpl_vars['enable_featured'] == '1'): ?>selected<?php endif; ?>>Có</option>
                											<option value="0" <?php if ($this->_tpl_vars['enable_featured'] == '0'): ?>selected<?php endif; ?>>Không</option>
                                                            </select>
                                                        </td>
...
" class=" required-entry required-entry input-text" type="text"/>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            ...
                                                            <option value="1" <?php if ($this->_tpl_vars['re_mobile'] == '1'): ?>selected<?php endif; ?>>Bật</option>
                                                            <option value="0" <?php if ($this->_tpl_vars['re_mobile'] == '0'): ?>selected<?php endif; ?>>Tắt</option>
                                                            </select>
                                                        </td>
