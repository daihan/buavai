<?php /* Smarty version 2.6.6, created on 2013-11-09 10:53:28
    ...
    <div id="scriptolution-soft-share" class="scriptolution-soft-box ">
        <div class="content">
            ...
            <form id="form-scriptolution-soft-share" class="modal" action="">
                ...
                <h4>Bài đăng của bạn được hiển thị trên trang&nbsp;<a href="<?php echo $this->_tpl_vars['baseurl']; ?>
/vote" target="_blank">Bình chọn</a>. Để được nhiều bình chọn hãy chia sẻ nó với mọi người!</h4>
