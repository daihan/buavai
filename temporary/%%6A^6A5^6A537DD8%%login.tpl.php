<?php /* Smarty version 2.6.6, created on 2013-11-14 19:17:03
...
" tabindex="3" maxlength="32"/>
                ...
                <div id="login-remember-block" class="field" style="font-size:14px">
                    <input type="checkbox" value="yes" name="remember" style="width:20px; border:0px; vertical-align: baseline">&nbsp;<?php echo $this->_tpl_vars['lang261']; ?>
