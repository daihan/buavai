...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'view.tpl', 79, false),array('modifier', 'date_format', 'view.tpl', 83, false),array('modifier', 'mb_truncate', 'view.tpl', 162, false),array('insert', 'get_fav_count', 'view.tpl', 85, false),array('insert', 'get_fav_status', 'view.tpl', 94, false),array('insert', 'return_fod', 'view.tpl', 130, false),array('function', 'math', 'view.tpl', 155, false),)), $this); ?>
    ...
    <div id="main">
        <div id="content-holder">
            <div class="post-info-pad">
                ...
                <p>
                    <a style="color:#05b2a0" href="<?php echo $this->_tpl_vars['baseurl']; ?>
...
"><b><?php echo ((is_array($_tmp=$this->_tpl_vars['p']['username'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
                    ...
                    <b><?php echo ((is_array($_tmp=$this->_tpl_vars['p']['time_added'])) ? $this->_run_mod_handler('date_format', true, $_tmp) : smarty_modifier_date_format($_tmp)); ?>
 <?php echo ((is_array($_tmp=$this->_tpl_vars['p']['time_added'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%I:%M %p") : smarty_modifier_date_format($_tmp, "%I:%M %p")); ?>
                    ...
                    <span class="comment"><b><fb:comments-count href="<?php echo $this->_tpl_vars['baseurl']; ?>
/gag/<?php echo $this->_tpl_vars['p']['PID']; ?>
"></fb:comments-count></b></span>
...
" ><b><?php echo $this->_tpl_vars['fcount']; ?>
</b></span></span>
					<span class="viewed"><b><?php echo $this->_tpl_vars['postview']; ?>
</b></span>
...
');"><b><?php echo $this->_tpl_vars['lang145']; ?>
</b></a>	
                    <?php endif; ?>										
                </p>
                <ul class="actions">
...
/login"><?php echo $this->_tpl_vars['lang144']; ?>
            ...
            <div id="post-control-bar" class="spread-bar-wrap">
                <div class="spread-bar">
                    <div class="facebook-btn" style="width:90px;"><fb:like href="<?php echo $this->_tpl_vars['baseurl']; ?>
/gag/<?php echo $this->_tpl_vars['p']['PID']; ?>
?ref=fb" send="false" layout="button_count" width="90" show_faces="false" font="" label="Post"></fb:like></div>
                    <div class="facebook-share-btn"><fb:share-button class=" fb_iframe_widget" href="<?php echo $this->_tpl_vars['baseurl']; ?>
/gag/<?php echo $this->_tpl_vars['p']['PID']; ?>
" type="button_count" fb-xfbml-state="rendered"></fb:share-button></div>
