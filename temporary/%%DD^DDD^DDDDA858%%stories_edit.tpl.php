<?php /* Smarty version 2.6.6, created on 2013-11-14 21:20:34
         compiled from administrator/stories_edit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('insert', 'get_all_users', 'administrator/stories_edit.tpl', 59, false),array('insert', 'return_youtube', 'administrator/stories_edit.tpl', 208, false),array('insert', 'return_fod', 'administrator/stories_edit.tpl', 212, false),array('modifier', 'stripslashes', 'administrator/stories_edit.tpl', 61, false),array('modifier', 'date_format', 'administrator/stories_edit.tpl', 106, false),)), $this); ?>
...
" target="_blank"><?php echo $this->_tpl_vars['story']['pip']; ?>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            ...
                                                            <option value="1" <?php if ($this->_tpl_vars['story']['feat'] == 1): ?>selected<?php endif; ?>>Có</option>
                                                            <option value="0" <?php if ($this->_tpl_vars['story']['feat'] == 0): ?>selected<?php endif; ?>>Không</option>
                                                            </select>
                                                        </td>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            ...
                                                            <option value="1" <?php if ($this->_tpl_vars['story']['rec'] == 1): ?>selected<?php endif; ?>>Có</option>
                                                            <option value="0" <?php if ($this->_tpl_vars['story']['rec'] == 0): ?>selected<?php endif; ?>>Không</option>
                                                            </select>
                                                        </td>
