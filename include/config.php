...
// Bắt đầu cấu hình
$config['basedir']     =  'C:\wamp\www\buavai'; //Đường đẫn đến thư mục chứa mã nguồn
$config['baseurl']     =  'http://buavai.local'; //Liên kết đến thư mục chứa mã nguồn

$DBTYPE = 'mysql';
$DBHOST = 'localhost'; //Tên máy chủ cơ sở dữ liệu
$DBUSER = 'root'; //Tên đăng nhập cơ sở dữ liệu
$DBPASSWORD = ''; //Mật khẩu kết nối cơ sở dữ liệu
$DBNAME = 'buavai'; //Tên cơ sở dữ liệu
